...
pub struct LayoutParamsPayload {
    ...
    pub viewport_aspect: Option<f64>,
    pub shape_slack_weight: Option<f64>,
    pub terminal_tuck_angles: Option<usize>,
    pub terminal_tuck_radius_steps: Option<usize>,
    pub terminal_tuck_min_radius_factor: Option<f64>,

        ...
        case 'creature':
            return (
                <svg {...commonProps}>
                    ...
                    <path d="M8.25 18.25c-1.9 0-3.25-1.47-3.25-3.2 0-2.2 1.95-4.05 4.35-4.05.92 0 1.84.28 2.65.82.81-.54 1.73-.82 2.65-.82 2.4 0 4.35 1.85 4.35 4.05 0 1.73-1.35 3.2-3.25 3.2-.98 0-1.88-.37-2.55-1.03A3.69 3.69 0 0112 18.25a3.7 3.7 0 01-1.65-.39 3.63 3.63 0 01-2.1.39z"/>
                </svg>
            )
        case 'event':
            return (
                <svg {...commonProps}>
                    ...
                    <path d="M12 12l.75 1.55 1.75.26-1.25 1.22.3 1.72L12 15.9l-1.55.85.3-1.72-1.25-1.22 1.75-.26L12 12z"/>
                </svg>
            )
        case 'concept':
            return (
                <svg {...commonProps}>
                    <path d="M12 4.25a5.25 5.25 0 00-3.27 9.36c.74.59 1.27 1.4 1.52 2.31h3.5c.25-.91.78-1.72 1.52-2.31A5.25 5.25 0 0012 4.25z"/>
